function A = generate_LP_constraints_valuecomp(P,P_polopt,R,d,num_states,all_pols,pol_opt,num_constraints)
...
for i = 1: num_constraints
    if (all_pols(i,:)') ~= pol_opt
        ...
        A( (const_iter-1)*num_states + 1 : const_iter*num_states, :  ) = inv( eye(num_states)- d*P_polopt ) - inv( eye(num_states)- d*P_pol);    
    end
end
